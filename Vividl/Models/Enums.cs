...
{
  [Description("OverwriteMode_None")] None,
...
{
  [Description("HwAccelMode_None")] None,

  [Description("HwAccelMode_NvidiaCuda")]
  NvidiaCuda,
  [Description("HwAccelMode_AmdAmf")] AmdAmf,
  [Description("HwAccelMode_IntelQsv")] IntelQsv,
}
...
{
  [Description("Min")] ResMin = 0,
  [Description("360p")] Res360 = 360,
  [Description("480p")] Res480 = 480,
  [Description("720p")] Res720 = 720,
  [Description("1080p")] Res1080 = 1080,
  [Description("Max")] ResMax = int.MaxValue
}