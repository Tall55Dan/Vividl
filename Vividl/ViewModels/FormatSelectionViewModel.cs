...
public class FormatSelectionViewModel : ViewModelBase
{
  ...
  public FormatData SelectedAudioVideo
  {
    ...
    set { applyFormatSelectionChange(selectedAudioVideo: value); }
  }

  public FormatData SelectedVideo
  {
    get => selectedVideo;
    set { applyFormatSelectionChange(selectedVideo: value, selectedAudio: SelectedAudio); }
  }

  public FormatData SelectedAudio
  {
    get => selectedAudio;
    set { applyFormatSelectionChange(selectedVideo: SelectedVideo, selectedAudio: value); }
  }
  ...
  public string FileExtension
  {
    get
    {
      ...
      if (SelectedDownloadOption == DownloadOptions.CustomDownloadIndex)
        ...
        return DownloadOptions[SelectedDownloadOption].GetExt(
